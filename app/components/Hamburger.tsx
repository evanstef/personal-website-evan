    ...
    {open && (
      ...
      {links.map((link,i) => (
            <motion.div key={i} initial={{x:-70,opacity:0}} animate={{x:0, opacity:1, transition:{delay:i * 0.3}}}>
              <Link key={link.title} className={`text-white hover:text-teal-500 text-2xl duration-300 ${getLink === link.url && "text-3xl text-teal-500 font-bold"}`} href={link.url} >
              {link.title}
              </Link>
            </motion.div>
       ...
       <motion.a initial={{scale:0}} animate={{scale:1}} transition={{delay:0.1}} href="https://www.instagram.com/evan_sc_333/"target='_blank' className='duration-300 text-white hover:text-teal-500'>
      ...
      <motion.a initial={{scale:0}} animate={{scale:1}} transition={{delay:0.2}} href="#" className='duration-300 text-white hover:text-teal-500'>
      ...
      <motion.a initial={{scale:0}} animate={{scale:1}} transition={{delay:0.3}} href="https://github.com/evanstef" target='_blank' className='duration-300 text-white hover:text-teal-500'>
